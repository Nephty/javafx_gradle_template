 ...
 */
public class TemplateEvent extends AbstractTemplateEvent {
    public TemplateEvent() {
        super(AbstractTemplateEvent.INVALID_VALUE);
    }

    @Override
    public void invokeHandler(TemplateEventHandler handler) {
        handler.onEvent();
    }
}